  ...
  # module Generators
    module Core
      ...
      def create_mutation_root_type
        create_dir("app/kms_graphql/mutations")
        template("mutation_type.erb", "app/kms_graphql/types/mutation_type.rb", { skip: true })
        insert_root_type('mutation', 'MutationType')
      end

      def schema_file_path
        "app/kms_graphql/#{schema_name.underscore}.rb"
      end
