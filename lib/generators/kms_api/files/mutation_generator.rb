  ...
  # module Generators
    ...
    class MutationGenerator < Rails::Generators::Base
      ...
      def create_mutation_file
        ...
        template "mutation.erb", "app/kms_graphql/mutations/#{file_name}.rb"

        sentinel = /name "Mutation"\s*\n/m
        in_root do
          gsub_file "app/kms_graphql/types/mutation_type.rb", /  \# TODO\: Add Mutations as fields\s*\n/m, ""
          inject_into_file "app/kms_graphql/types/mutation_type.rb", "  field :#{field_name}, Mutations::#{mutation_name}.field\n", after: sentinel, verbose: false, force: false
        end
      end
